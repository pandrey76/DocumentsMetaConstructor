...
class Feedback:
    ...
    def __init__(self, master):
        ...
        image_file = path.abspath("tour_logo.gif")
        self.logo = PhotoImage(file=image_file)
        ...
        ttk.Button(self.frame_content, text='Submit', command=self.submit).grid(row=4, column=0, padx=5, pady=5,
                                                                                sticky='e')
        ttk.Button(self.frame_content, text='Clear', command=self.clear).grid(row=4, column=1, padx=5, pady=5,
                                                                              sticky='w')
